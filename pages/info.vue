      ...
      <div class="bg-white dark:bg-slate-700 py-12 flex">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div class="lg:text-center">
            <h2 class="text-lg font-semibold text-indigo-600">Status</h2>
            <p
              class="mt-2 text-3xl font-bold leading-8 tracking-tight text-gray-900 dark:text-white sm:text-4xl"
            >
              Current Application
            </p>
            ...
            >
              <div class="relative">
                <dt>
                  ...
                  <p
                    class="ml-16 text-lg font-medium leading-6 text-gray-900 dark:text-white"
                  >
                    Release Version
                  </p>
                </dt>
                <NuxtLink
                  v-if="getReleaseVersion() !== 'not available'"
                  :to="
                    'https://github.com/jurassicjs/nuxt3-fullstack-tutorial/releases/tag/' +
                    getReleaseVersion()
                  "
                >
                  <dd
                    class="mt-2 ml-16 text-base text-gray-500 dark:text-white"
                  >
                    {{ getReleaseVersion() }}
                  </dd>
                </NuxtLink>
              ...
              <div class="relative">
                ...
                <NuxtLink
                  v-if="gitHash !== 'not available'"
                  :to="
                    'https://github.com/jurassicjs/nuxt3-fullstack-tutorial/commit/' +
                    gitHash
                  "
                >
                  <dd
