  ...
  >
    ...
    <div class="md:flex">
      ...
      <div class="w-full md:w-1/3">
        <div
          class="p-8 text-white bg-lime-600 dark:bg-slate-800 rounded shadow-md"
          v-if="showDeleted"
        >
          question deleted
        </div>
...
const { data: question } = useFetch<IQuestion>(
  `/api/ask-jack/question?id=${questionId}`,
  { server: false }
);
