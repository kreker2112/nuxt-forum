        ...
        <div class="flex justify-between space-x-5 align-bottom mt-14">
          <NuxtLink to="https://github.com/jurassicjs/nuxt3-fullstack-tutorial">
            <svg
              ...
              aria-hidden="true"
              role="img"
              class="dark:text-gray-50 h-6 w-6 hidden lg:block hover:dark:text-gray-400 hover:text-gray-400"
              width="0.97em"
              height="1em"
          ...
          <NuxtLink
            to="https://discord.gg/9XXEvE43pG"
            class="text-gray-800 hidden lg:block"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              xmlns:xlink="http://www.w3.org/1999/xlink"
              class="text-black dark:text-gray-200 h-6 w-6 ml-2 hover:dark:text-purple-400 hover:text-purple-400"
          ...
          <NuxtLink to="https://twitter.com/full_stack_jack">
            <svg
              class="dark:text-gray-50 h-6 w-6 hidden lg:block hover:dark:text-blue-400 hover:text-blue-400"
              fill="none"
              viewBox="0 0 24 24"
            >
              <path
