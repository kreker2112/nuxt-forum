  ...
  <div>
    <dialog-box @rehide="rehide" dismiss-text="dismiss" :hide="hideDialog">
      ...
      <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
        ...
        <div class="mt-2">
          <p class="mt-5">You must be logged in to ask a question</p>
    ...
    <div class="pt-5 z-10 boarder justify-right sm:fixed">
      <div class="w-100 sm:block" aria-label="Sidebar">
        <div
          class="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-900"
        >
          <span
            v-if="route.path !== '/ask-jack/ask'"
            @click="goToAskForm"
            type="button"
          ...
          <nuxt-link
            v-if="route.path !== '/ask-jack/search'"
            to="/ask-jack/search"
            type="button"
          ...
          <ul class="space-y-2 hidden sm:block">
            ...
            <li>
              ...
              >
                ...
                <span class="flex-1 ml-3 whitespace-nowrap">Give Props</span>
              </a>
            </li>
            <li>
              <a
